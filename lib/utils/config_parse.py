...
__C.MODEL.PRIOR_BOX = 'v2'
__C.MODEL.K = 2

# Mean and STD for Pre-processing
__C.MODEL.MEANS = (104, 117, 123)
__C.MODEL.STDS = (0.225, 0.224, 0.229)
# What kind of aggregation to use for temporal axis
__C.MODEL.TEMPORAL_LAYER = ['mean', 'mean', 'mean', 'mean', 'mean', 'mean']
__C.MODEL.VARIANCE = [0.1, 0.2]
# Fusion with optical flow
__C.MODEL.FUSION_LEVEL = 'decision'
# What type of fusion
__C.MODEL.FUSION_TYPE = 'mean'
...
__C.TRAIN.EVAL_ITER = 5
# The number of max iters
__C.TRAIN.MAX_ITERATIONS = 100
__C.TRAIN.MAX_EPOCHS = 100
# Minibatch size
__C.TRAIN.BATCH_SIZE = 128
# trainable scope and resuming scope
__C.TRAIN.TRAINABLE_SCOPE = 'feature_extractor,extras,loc,conf'
...
__C.DATASET.NUM_CLASSES = 25
# Flow or RGB
__C.DATASET.INPUT_TYPE = 'RGB'
# Interval between frames
__C.DATASET.INTERVAL = 1

# Copy some attributes
__C.MODEL.INPUT_TYPE = __C.DATASET.INPUT_TYPE
__C.MODEL.NUM_CLASSES = __C.DATASET.NUM_CLASSES
__C.MATCHER.NUM_CLASSES = __C.MODEL.NUM_CLASSES
__C.POST_PROCESS.NUM_CLASSES = __C.MODEL.NUM_CLASSES
...
def cfg_from_file(eCfg):
    """Load a config file and merge it into the default options."""
    with open(eCfg, 'r') as f:
        yaml_cfg = AttrDict(yaml.load(f, Loader))
